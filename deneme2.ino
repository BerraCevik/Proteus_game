...
int lives = 3; // Çubuğun can sayısını takip etmek için bir değişken ekleyin
int level = 1; // Hangi seviyede olduğunuzu takip etmek için bir değişken ekleyin
bool startSelected = false;
int ballX = 64, ballY = 50; // Topun başlangıç konumu
int ballSpeedX = 4, ballSpeedY = -4; // Topun hızı
// Skor
int score = 0;
// "O" harfinin konumunu ve hızını saklayan bir yapı oluşturun
struct LetterO {
  int x, y;
  int speedY;
};

// Kırılan her blok için bir "O" harfi oluşturun
